...
class SouvenirGifCreation : Activity() {
    ...
    private fun createSouvenirGif() {
        createClassifier()
        val souvenirGifCreationThread = SouvenirGifCreationThread(classifier, applicationContext, curStoryName, storyStartDate, storyEndDate, storyStartTime, storyEndTime)
