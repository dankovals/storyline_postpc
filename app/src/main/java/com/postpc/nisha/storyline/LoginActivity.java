...
//            LoginActivity.getGoogleApiHelper().buildGoogleApiClient();
    ...
    public void btn_start_new_story_clicked(View v){
        ...
        // TODO: 27/09/2018 change the initiation of createStoryActivity (instead of "temp")
...
//    /**
//     * when the user clicked on the sign up button-
//     * switch to Register activity.
//     */
//    public void btn_loginAct_signUp_clicked(View v){
//        Intent intentToRegisterActivity = new Intent(LoginActivity.this,
